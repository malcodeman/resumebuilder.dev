...
function NairobiReact(props: props) {
  ...
  const styles = {
    ...
    leftColumn: {
      ...
      paddingLeft: utils.pt2px(20 * design.spacing),
    ...
    sectionLabel: {
      ...
      fontSize: utils.pt2px(theme.fontSize.md * design.spacing),
    },
    summary: {
      lineHeight: 1.4,
    },
  ...
  return (
    <div style={styles.page} id="nairobi">
